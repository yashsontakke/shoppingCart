...
import * as actions from '/Users/beingyash/Downloads/drive-download-20230110T075814Z-001/src/redux/actions.js'
// import {
//   loadCurrentItem,
//   addToCart,
...
const mapDispatchToProp= (dispatch) => {
  return {
    loadCurrentItem :(item) => dispatch({type:actions.LOAD_CURRENT_ITEM , payload : {item:item}}),
